...
// Repita a questão de Ordenação por Seleção, contudo, usando o algoritmo de Inserção, fazendo com que a chave de pesquisa seja o atributo dateOfBirth. O nome do arquivo de log será matrícula_insercao.txt.
