/*Repita a questão de Ordenação por Seleção, contudo, usando o algoritmo da Bolha, fazendo com que a chave de pesquisa seja o atributo hairColour. 
O nome do arquivo de log será matrícula_bolha.txt.*/
...
void Log(int comparacoes, int movimentacoes, double tempoExecucao){
    ...
    if((log = fopen("775799_bolha.txt","w")) != NULL){
