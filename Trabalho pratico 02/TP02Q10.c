/*Repita a questão de Ordenação por Seleção, contudo, usando o algoritmo Quicksort, fazendo com que a chave de pesquisa seja o atributo house.
O nome do arquivo de log será matrícula_quicksort.txt.*/
...
void Log(int comparacoes, int movimentacoes, double tempoExecucao)
{
    ...
    if ((log = fopen("775799_quicksort.txt", "w")) != NULL)
    {
